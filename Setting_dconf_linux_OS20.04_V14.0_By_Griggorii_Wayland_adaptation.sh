...
[SettingsWindow]
geometry=@ByteArray(\x1\xd9\xd0\xcb\0\x3\0\0\0\0\x1\x45\0\0\0\x32\0\0\x4#\0\0\x2\xf7\0\0\x1\x45\0\0\0W\0\0\x4#\0\0\x2\xf7\0\0\0\0\0\0\0\0\x5V\0\0\x1\x45\0\0\0W\0\0\x4#\0\0\x2\xf7)
EOF
...
dock-items=['liteusermanager.dockitem', 'gufw.dockitem', 'gparted.dockitem', 'org.gnome.baobab.dockitem', 'org.gnome.DiskUtility.dockitem', 'Thunar.dockitem', 'caja.dockitem', 'org.gnome.Nautilus.dockitem', 'nemo.dockitem', 'org.gnome.Terminal.dockitem', 'terminology.dockitem', 'lxterminal.dockitem', 'gnome-system-monitor.dockitem', 'alacarte-made-48.dockitem', 'synaptic.dockitem', 'org.gnome.Todo.dockitem', 'org.gnome.Totem.dockitem', 'xfce-display-settings.dockitem', 'mate-about.dockitem', 'unity-tweak-tool.dockitem', 'systemback.dockitem', 'exo-preferred-applications.dockitem', 'onboard.dockitem', 'onboard-settings.dockitem', 'libreoffice-startcenter.dockitem', 'libreoffice-calc.dockitem', 'libreoffice-writer.dockitem', 'yelp.dockitem', 'JB-controlpanel-jdk8.dockitem', 'JB-policytool-jdk8.dockitem', 'JB-mission-control-jdk8.dockitem', 'JB-jvisualvm-jdk8.dockitem', 'JB-java-jdk8.dockitem', 'ca.desrt.dconf-editor.dockitem', 'org.gnome.Extensions.dockitem', 'gnome-ppp.dockitem', 'PlayOnLinux.dockitem', 'obs.dockitem', 'com.obsproject.Studio.dockitem', 'thunderbird.dockitem', 'rhythmbox.dockitem', 'com.github.wwmm.pulseeffects.dockitem', 'pavucontrol.dockitem', 'firefox.dockitem']
hide-delay=500
...
active-plugins=['quickhighlight', 'spell', 'filebrowser', 'quickopen', 'pythonconsole', 'snippets', 'docinfo', 'externaltools', 'time', 'modelines']

[org/gnome/gedit/plugins/filebrowser]
root='file:///'
tree-view=true
virtual-root='file:///root/linux-oem-5.6-5.6.0/debian/build/build-oem/include/generated/uapi/linux'
...
favorite-apps=['org.gnome.Screenshot.desktop', 'ubiquity.desktop', 'firefox.desktop', 'nemo.desktop', 'org.gnome.Nautilus.desktop', 'gnome-control-center.desktop', 'libreoffice-startcenter.desktop', 'com.gexperts.Tilix.desktop', 'gnome-system-monitor.desktop', 'org.gnome.tweaks.desktop', 'com.obsproject.Studio.desktop', 'org.gnome.DiskUtility.desktop', 'nvidia-settings.desktop', 'ca.desrt.dconf-editor.desktop', 'brave-browser-beta.desktop']
...
EOF
firefox https://www.youtube.com/watch?v=9B-nTJyEZX0
EOF
killall plank
EOF
plank
